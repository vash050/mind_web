...
function fetchpost() {
  ...
  fetch(url, {
    ...
    .then((res) => {
      if (res.ok) {
        // animation for information block if form sent
        TL.fromTo(
          ".footer-form",
          { autoAlpha: 1, y: 0 },
          ...
          .to(".messSent", { autoAlpha: 0, y: -50, duration: 0.6 }, 5)
          .to(
            ".p-message",
            { autoAlpha: 0, y: -50, duration: 0.4, stagger: 0.2 },
            "-=0.5"
        ...
        TL.fromTo(
          ...
          .to(".messNotSent", { autoAlpha: 0, y: -50, duration: 0.6 }, 5)
          .to(
            ".p-message",
            { autoAlpha: 0, y: -50, duration: 0.4, stagger: 0.2 },
            "-=0.5"
